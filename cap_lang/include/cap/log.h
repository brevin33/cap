...
void log_warning(u32 file, u32 start_char, u32 end_char, const char *format, ...);

void log_info(Ast *ast, const char *format, ...);

void log_error_va_list(u32 file, u32 start_char, u32 end_char, const char *format, u32 type, va_list args);
