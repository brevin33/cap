...
typedef struct LLVM_Function_Info_Function_Pair LLVM_Function_Info_Function_Pair;
typedef struct LLVM_Module_Info LLVM_Module_Info;
typedef struct LLVM_Function_Implementation_Info LLVM_Function_Implementation_Info;
...
struct LLVM_Function_Implementation_Info {
...
struct LLVM_Function_Info_Function_Implementation_Pair {
    ...
    LLVM_Function_Implementation_Info function_info;
};

struct LLVM_Function_Info_Function_Pair {
    Function* function;
...
struct LLVM_Module_Info {
    ...
    LLVM_Function_Info_Function_Pair* function_infos_by_name;
    u64 function_infos_by_name_count;
    u64 function_infos_by_name_capacity;
};
